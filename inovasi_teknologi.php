...
<head>
    ...
    <title>Inovasi Teknologi Terapan - Pengembangan Inovasi</title>
...
<body>
    ...
    <main>
        <section class="section">
            <div class="container">
                <h2 class="section-title">Inovasi Teknologi Terapan</h2>
                <p class="section-desc" style="text-align:center; max-width:700px; margin:0 auto 32px auto;">Berisi berbagai kegiatan, program, dan karya inovatif di bidang teknologi terapan untuk mendukung konservasi dan pengelolaan sumber daya alam.</p>
                <div class="inovasi-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 32px; margin-top: 40px;">
                    <?php
                    $inovasi_list = $conn->query("SELECT * FROM inovasi WHERE kategori='teknologi' AND status='active' ORDER BY tanggal DESC");
                    ...
                    ?>
                        <div class="inovasi-card" style="background: #fff; border-radius: 14px; box-shadow: 0 2px 12px rgba(44,62,80,0.10); padding: 32px 18px 28px 18px; text-align: center; transition: transform 0.3s ease, box-shadow 0.3s ease;">
                            <div style="font-size:2.5rem; color:#f59e42; margin-bottom:18px;"><i class="fa-solid fa-microchip"></i></div>
                            ...
                            <a href="detail_inovasi.php?id=<?= $inovasi['id'] ?>" class="btn-primary" style="display: inline-block; margin-top: 15px; padding: 10px 20px; background: #f59e42; color: white; text-decoration: none; border-radius: 8px; font-weight: 600;">Lihat Detail</a>
                        </div>
                    <?php 
                        endwhile;
                    else:
                    ?>
                        <div class="inovasi-card" style="background: #fff; border-radius: 14px; box-shadow: 0 2px 12px rgba(44,62,80,0.10); padding: 32px 18px 28px 18px; text-align: center; grid-column: 1 / -1;">
                            <div style="font-size:2.5rem; color:#f59e42; margin-bottom:18px;"><i class="fa-solid fa-microchip"></i></div>
                            <h3 style="font-size:1.1rem; font-weight:700; margin-bottom:10px;">Belum ada inovasi teknologi terapan</h3>
                            <p style="color:#555;">Konten inovasi teknologi terapan akan ditampilkan di sini.</p>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
